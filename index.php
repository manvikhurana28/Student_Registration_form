		...
		<div class="profile_info">
			...
			<div>
				<?php  if (isset($_SESSION['user'])) : ?>
					...
					<small>
						<i  style="color: rgb(2, 2, 2);">(<?php echo ucfirst($_SESSION['user']['user_type']); ?>)</i> 
						<br>
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="index.html">  
                            <img class="img-fluid" src="assets/images/logo1.png" alt="Theme-Logo" width="40" height="50" /><b>     SMS SYSTEM</b> 
                        </a>
                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                ...
                                <ul class="show-notification">
                                    ...
                                    <li>
                                        <div class="media">
                                            <img class="d-flex align-self-center" src="my.jpeg" alt="Generic placeholder image">
                                            <div class="media-body">
                                                <h5 class="notification-user">Abhinav</h5>
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!">
                                    <img src="my.jpeg" class="img-radius" alt="User-Profile-Image">
                                    <span>Abhinav</span>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-40 img-radius" src="my.jpeg" alt="User-Profile-Image">
